...
//					},
	...
	methods: {
		...
		handleAdd () {
			let param = {}
			this.$refs.TpDialog.show('/sys/custom/module/add.vue', param, '新增')
		},
		// 修改方法
		handleEdit (row) {
			...
			this.$refs.TpDialog.show('/sys/custom/module/add.vue', param, '修改')
		},
		// 删除方法
		handleDel (row) {
			this.$confirm('确定要删除吗？', () => {
		...
		handleView (row) {
			...
			let param = {'id': row.mid}
			this.$refs.TpDialog.show('/sys/custom/module/view.vue', param, '查看')
		},
