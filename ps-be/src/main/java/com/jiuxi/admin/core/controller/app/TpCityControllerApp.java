 ...
 */
@RestController
@RequestMapping("/app/sys/city")
public class TpCityControllerApp {
     ...
     */
    @RequestMapping("/tree")
    public JsonResponse tree(@RequestParam(value = "cityId") String cityId, @RequestParam(value = "sync", defaultValue = "1") int sync, @RequestParam(value = "expand", required = false, defaultValue = "false") boolean expand, @RequestParam(value = "showTop", required = false, defaultValue = "off") String showTop) {
    ...
    public JsonResponse select(String cityId) {
