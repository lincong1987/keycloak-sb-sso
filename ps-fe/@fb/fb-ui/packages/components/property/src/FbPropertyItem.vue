...
export default {
	...
	data () {
		...
		let fbProperty = this.fbProperty || closest(this, 'FbProperty')
	...
	created () {
		...
		this.fbProperty = closest(this, 'FbProperty')
...
//		if (this.myMode === 'table') {
//			this.fbRow = closest(this, 'FbRow')
//		}
	...
	methods: {
		...
		updateRowHeight () {
			...
			if (fbProperty.bordered) {
				this.$nextTick(() => {
					fbProperty.debounceSyncItemHeight()
				})
			}
...
<!--<template>-->
<!--	<td :class="getClass" :colspan="span">-->
<!--		<span :class="`${prefix}-property-item__label`" :style="getLabelStyle">-->
<!--			<slot name="label">{{ label }}</slot>-->
<!--		</span>-->
<!--		<span :class="`${prefix}-property-item__content`">-->
<!--			<slot>{{ value }}</slot>-->
<!--		</span>-->
<!--	</td>-->
<!--</template>-->
