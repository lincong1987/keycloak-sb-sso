 ...
 */
public class TpCustomModuleVO implements Serializable {
     ...
     * 模块名称
     */
    @NotBlank(message = "模块名称不能为空", groups = {AddGroup.class})
    private String mname;

    /**
     * 模块编码 表名,自动添加前缀: C_JSON_
     */
    @NotBlank(message = "模块编码不能为空", groups = {AddGroup.class})
