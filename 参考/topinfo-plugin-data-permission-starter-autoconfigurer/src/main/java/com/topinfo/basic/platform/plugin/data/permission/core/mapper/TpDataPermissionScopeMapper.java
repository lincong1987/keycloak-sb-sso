...
public interface TpDataPermissionScopeMapper {
     ...
     * @return int
     * @author 杨占锐
     * @date 2024/12/3 19:21
     */
    int add(TpDataPermissionScope bean);
     ...
     * @date 2024/12/3 19:21
     */
    int update(TpDataPermissionScope bean);
     ...
     * @param personId 人员id
     * @param deptId   部门id
     * @return com.topinfo.basic.platform.plugin.data.permission.core.bean.vo.TpDataPermissionScopeVO
     * @author 杨占锐
