	...
	<div class="tp-dialog">
		<div class="tp-dialog-top">
			<fb-property bordered label-width="130px" mode="form">
				...
				<fb-row>
					<fb-col span="12">
						<fb-property-item label="审批部门">
							{{formData.appDept}}
						</fb-property-item>
					</fb-col>
					<fb-col span="12">
						<fb-property-item label="审批内容">
							{{formData.appContent}}
						</fb-property-item>
					</fb-col>
				</fb-row>
	...
	export default {
		...
		methods: {
			...
			view() {
				// 调用新增service方法
				let that = this;
				this.service.view({"appId": that.formData.appId}).then((result) => {
					// 判断code
					if (result.code == 1) {
