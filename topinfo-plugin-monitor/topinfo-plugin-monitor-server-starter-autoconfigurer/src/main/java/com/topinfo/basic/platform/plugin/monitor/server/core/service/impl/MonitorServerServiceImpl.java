...
import com.topinfo.basic.platform.plugin.monitor.server.core.bean.vo.AlarmSource;
...
import com.topinfo.basic.platform.plugin.monitor.server.core.service.*;
import com.topinfo.basic.platform.plugin.monitor.server.core.util.MonitorIpUtil;
import com.topinfo.basic.platform.plugin.monitor.server.core.util.MonitorMD5Util;
...
public class MonitorServerServiceImpl implements MonitorServerService {
    ...
    private void sendMail(TpMonitorClientVO clientVO, AlarmSource alarmSource) {
        ...
        if (null == config) {
            LOGGER.info("邮件配置为空，不发送邮件，clientVO：{}, alarmEventList：{}"
