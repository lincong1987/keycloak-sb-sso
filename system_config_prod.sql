...
INSERT INTO `tp_system_config` (`config_key`, `config_value`, `config_type`, `description`, `create_time`, `update_time`) VALUES ('admin.logo','./logo/admin-logo.png','string','管理后台Logo地址','2025-08-29 21:24:54','2025-09-03 22:00:25');
INSERT INTO `tp_system_config` (`config_key`, `config_value`, `config_type`, `description`, `create_time`, `update_time`) VALUES ('admin.title','中共陕西省委党校（陕西行政学院）业务中台','string','管理后台标题','2025-08-29 21:24:54','2025-09-03 22:00:15');
INSERT INTO `tp_system_config` (`config_key`, `config_value`, `config_type`, `description`, `create_time`, `update_time`) VALUES ('browser.title','中共陕西省委党校（陕西行政学院）业务中台','string','浏览器标题','2025-08-31 20:25:03','2025-09-03 22:00:45');
...
INSERT INTO `tp_system_config` (`config_key`, `config_value`, `config_type`, `description`, `create_time`, `update_time`) VALUES ('login.logo','./logo/admin-logo.png','string','登录页面Logo地址','2025-08-29 21:24:54','2025-09-03 22:03:27');
INSERT INTO `tp_system_config` (`config_key`, `config_value`, `config_type`, `description`, `create_time`, `update_time`) VALUES ('login.title','中共陕西省委党校（陕西行政学院）业务中台','string','登录页面标题','2025-08-29 21:24:54','2025-09-03 22:03:21');
...
INSERT INTO `tp_system_config` (`config_key`, `config_value`, `config_type`, `description`, `create_time`, `update_time`) VALUES ('system.copyright','© 2025 中共陕西省委党校（陕西行政学院）版权所有','string','版权信息','2025-08-29 21:24:54','2025-09-03 22:02:48');
...
INSERT INTO `tp_system_config` (`config_key`, `config_value`, `config_type`, `description`, `create_time`, `update_time`) VALUES ('system.name','中共陕西省委党校（陕西行政学院）业务中台','string','系统名称','2025-08-29 21:24:54','2025-09-03 22:02:56');
