<template>
	<div class="tp-dialog">
		<div class="tp-dialog-top" style=" overflow-y: auto; overflow-x: hidden">
			<fb-dialog-table>
				<template slot="form">
					<fb-form ref="query-form" style="padding: 0px" :label-width="80">
						<fb-row>
							<fb-col span="11">
