...
public class HomeController {
    ...
    public String dashboard(@AuthenticationPrincipal OAuth2User principal, Model model) {
        if (principal != null) {
            ...
            model.addAttribute("systemName", "系统A");
        }
        return "dashboard";
    }
    ...
    public String logout(HttpServletRequest request, HttpServletResponse response) {
        ...
        String keycloakLogoutUrl = "http://localhost:8080/realms/demo/protocol/openid-connect/logout?redirect_uri=http://localhost:8081/system-a/";
