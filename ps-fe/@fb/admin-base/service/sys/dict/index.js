...
export default {
	...
	list(formData) {
		return app.service.get('/sys/dict/list', {params: formData})
	},
	...
	// 单选下拉
	tree (formData) {
		return  app.service.get('/sys/dict/tree', {params: formData})
	},

	view(formData) {
		return app.service.get('/sys/dict/view', {params: formData})
	},
