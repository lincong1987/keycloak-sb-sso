...
var DEFAULT_DOWNLOAD_NAME = 'test';
...
function getPDFFileNameFromURL(url) {
  ...
  return suggestedFilename || DEFAULT_DOWNLOAD_NAME+'.pdf' || 'test.pdf';
}
  ...
  TextLayerBuilder.prototype = {
    ...
    renderLayer: function TextLayerBuilder_renderLayer() {
      ...
      for (var i = 0; i < textDivsLength; i++) {
        ...
        if (textDiv.dataset && textDiv.dataset.isWhitespace !== undefined) {
          continue;
        }
        ...
        if (width > 0) {
          ...
          var transform;
          if (textDiv.dataset && textDiv.dataset.canvasWidth !== undefined) {
          ...
          var rotation = textDiv.dataset && textDiv.dataset.angle;
          if (rotation) {
...
function webViewerInitialized() {
  ...
  DEFAULT_DOWNLOAD_NAME = params.name
