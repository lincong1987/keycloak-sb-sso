<template>
	<div :class="[`${prefix}-color-alpha-slider`, { 'is-vertical': vertical }]">
		<div :class="`${prefix}-color-alpha-slider__bar`"
			 @click="handleClick"
			 ref="bar"
			 :style="{
		...
		<div :class="`${prefix}-color-alpha-slider__thumb`"
			 ref="thumb"
			 :style="{
				   left: thumbLeft + 'px',
				   top: thumbTop + 'px'
