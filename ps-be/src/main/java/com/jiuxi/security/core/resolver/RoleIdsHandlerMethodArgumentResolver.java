...
/**
 * @ClassName: DeptIdHandlerMethodArgumentResolver
 * @Description: RoleIds参数解析器
 * @Author: 杨攀
 * @Date: 2020/5/28 21:05
 * @Copyright: 2020 www.tuxun.net Inc. All rights reserved.
 */
public class RoleIdsHandlerMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter methodParameter) {
        ...
        if ("jwtrids".equalsIgnoreCase(name)) {
            return true;
        }
        return false;
    }
