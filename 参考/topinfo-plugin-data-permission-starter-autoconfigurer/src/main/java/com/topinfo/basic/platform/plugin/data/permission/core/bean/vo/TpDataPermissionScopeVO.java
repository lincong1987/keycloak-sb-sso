package com.topinfo.basic.platform.plugin.data.permission.core.bean.vo;
...
public class TpDataPermissionScopeVO implements Serializable {
	 ...
	 * 指定部门集合
	 */
	private List<TreeNode> deptNodes;
	...
	public List<TreeNode> getDeptNodes() {
		return deptNodes;
	}

	public void setDeptNodes(List<TreeNode> deptNodes) {
