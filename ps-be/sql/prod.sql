...
('login.title', '用户登录22', 'string', '登录页面标题', '2025-08-29 21:24:54', '2025-08-29 21:51:17'),
...
('system.copyright', '© 2025 管理系统 版权所有', 'string', '版权信息', '2025-08-29 21:24:54', '2025-08-29 21:57:52'),
('system.language', 'zh-CN', 'string', '系统语言', '2025-08-29 21:24:54', '2025-08-29 21:24:54'),
('system.name', '管理系统1112', 'string', '系统名称', '2025-08-29 21:24:54', '2025-08-29 22:09:38'),
...
-- 如果需要更新已存在的数据，可以使用以下格式：
-- INSERT INTO ... ON DUPLICATE KEY UPDATE config_value = VALUES(config_value), update_time = NOW();