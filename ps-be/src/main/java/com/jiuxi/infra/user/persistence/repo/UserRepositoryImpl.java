package com.jiuxi.infra.user.persistence.repo;

import com.jiuxi.domain.user.model.User;
import com.jiuxi.domain.user.model.UserProfile;
import com.jiuxi.domain.user.model.UserAccount;
import com.jiuxi.domain.user.model.ContactInfo;
import com.jiuxi.domain.user.model.UserStatus;
import com.jiuxi.domain.user.model.UserCategory;
import com.jiuxi.domain.user.model.AccountStatus;
import com.jiuxi.domain.user.repo.UserRepository;
import com.jiuxi.infra.user.persistence.entity.UserPO;
import com.jiuxi.infra.user.persistence.mapper.UserMapper;
...
public class UserRepositoryImpl implements UserRepository {
    ...
    private UserPO toUserPO(User user) {
        ...
        if (profile != null) {
            ...
            userPO.setSex(profile.getSex() != null ? String.valueOf(profile.getSex()) : null);
    ...
    private User toUser(UserPO userPO) {
        ...
        profile.setSex(userPO.getSex() != null ? Integer.valueOf(userPO.getSex()) : null);
