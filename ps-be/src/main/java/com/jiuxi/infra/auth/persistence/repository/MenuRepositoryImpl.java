...
import com.jiuxi.domain.auth.model.Menu;
import com.jiuxi.domain.auth.repo.MenuRepository;
import com.jiuxi.infra.auth.persistence.entity.MenuPO;
import com.jiuxi.infra.auth.persistence.mapper.MenuMapper;
...
public class MenuRepositoryImpl extends ServiceImpl<MenuMapper, MenuPO> implements MenuRepository {
    ...
    private Menu toEntity(MenuPO menuPO) {
        ...
        menu.setMenuType(menuPO.getMenuType() != null ? 
            com.jiuxi.domain.auth.model.MenuType.fromCode(menuPO.getMenuType()) : null);
        ...
        menu.setStatus(menuPO.getStatus() != null ? 
            com.jiuxi.domain.auth.model.MenuStatus.fromCode(menuPO.getStatus()) : null);
