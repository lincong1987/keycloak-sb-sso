	...
	<div class="tp-dialog">
		<div class="tp-dialog-top">
			<fb-property bordered label-width="130px" mode="form">
				...
				<fb-row>{{ formData.operterType }}
					<fb-col span="12">
						<fb-property-item label="模块">
							{{ formData.moduleCode }}
						</fb-property-item>
					</fb-col><fb-col span="12">
						<fb-property-item label="类型">
							{{ formData.operterType }}
						</fb-property-item>
					</fb-col>
				</fb-row>
				<fb-row>
				...
				<fb-row>
					<fb-col span="24">
						<fb-property-item label="浏览器">
							{{ formData.operterBrowser }}
						</fb-property-item>
					</fb-col>
				</fb-row>
				<!-- <fb-row>
