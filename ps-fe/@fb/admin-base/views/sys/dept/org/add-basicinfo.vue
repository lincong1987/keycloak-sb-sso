<template>
	<div class="tp-dialog">
		<div class="tp-dialog-top">
			<fb-form ref="fbform" :rule="rules" :label-width="120">
				<fb-row>
					<fb-col span="12">
					...
					<fb-col span="12">
						<fb-form-item label="行政区划" prop="cityCode" :rule="{required: true}">
							<fb-tree-select
								...
								:param="{'sync': 1, 'expand': false, 'showTop': 'on'}"
...
<!--								:param="{'sync': 1, 'expand': false, 'cityId': '-1' , 'showTop': 'on'}"-->
<!--								:reader="{value:'extend02', label: 'text'}"-->
<!--								:placeholder="'请选择'"-->
				...
				<fb-row>
					<fb-col span="24">
						<fb-form-item label="部门描述">
							<fb-textarea rows="2" v-model="formData.deptDesc" type="text" placeholder="请输入内容"
										 :maxlength="200">
							</fb-textarea>
						</fb-form-item>
					</fb-col>
