package com.jiuxi.infra.auth.persistence.repository;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.jiuxi.domain.auth.model.Role;
import com.jiuxi.domain.auth.repo.RoleRepository;
import com.jiuxi.infra.auth.persistence.entity.RolePO;
import com.jiuxi.infra.auth.persistence.mapper.RoleMapper;
...
public class RoleRepositoryImpl extends ServiceImpl<RoleMapper, RolePO> implements RoleRepository {
    ...
    private Role toEntity(RolePO rolePO) {
        ...
        role.setRoleType(rolePO.getRoleType() != null ? 
            com.jiuxi.domain.auth.model.RoleType.valueOf(rolePO.getRoleType()) : null);
        role.setStatus(rolePO.getStatus() != null ? 
            com.jiuxi.domain.auth.model.RoleStatus.fromCode(rolePO.getStatus()) : null);
        role.setBuiltIn(rolePO.getBuiltIn());
        role.setDeptId(rolePO.getDeptId());
        role.setDataScope(rolePO.getDataScope() != null ? 
            com.jiuxi.domain.auth.model.DataScope.valueOf(rolePO.getDataScope()) : null);
