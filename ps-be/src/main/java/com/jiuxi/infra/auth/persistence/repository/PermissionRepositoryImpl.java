...
import com.jiuxi.domain.auth.model.Permission;
import com.jiuxi.domain.auth.repo.PermissionRepository;
import com.jiuxi.infra.auth.persistence.entity.PermissionPO;
import com.jiuxi.infra.auth.persistence.mapper.PermissionMapper;
...
public class PermissionRepositoryImpl extends ServiceImpl<PermissionMapper, PermissionPO> implements PermissionRepository {
    ...
    private Permission toEntity(PermissionPO permissionPO) {
        ...
        permission.setPermissionType(permissionPO.getPermissionType() != null ? 
            com.jiuxi.domain.auth.model.PermissionType.fromCode(permissionPO.getPermissionType()) : null);
        permission.setStatus(permissionPO.getStatus() != null ? 
            com.jiuxi.domain.auth.model.PermissionStatus.fromCode(permissionPO.getStatus()) : null);
