    ...
    resetIcon: function(options) {
        ...
        var Icon = L.DivIcon.extend({
            createIcon: function() {
                ...
                v.div.style.transform = 'translate3d(-' + options.iconAnchor[0] + 'px, -' + options.iconAnchor[1] + 'px, 0) rotate(-' + v._latlngs[0].bearing + 'deg)';
            ...
            rotate(deg) {
                ...
                v.div.style.transform = 'translate3d(-' + options.iconAnchor[0] + 'px, -' + options.iconAnchor[1] + 'px, 0) rotate(-' + deg + 'deg)';
                v.before = deg
            },
