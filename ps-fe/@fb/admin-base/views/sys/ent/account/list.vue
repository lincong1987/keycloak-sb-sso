			...
			<template slot="table">
				<fb-simple-table
					...
					<template v-slot:actions="props">
						<fb-space>
							<fb-button @on-click="handleAccount(props.row)" editor
									   size="s" v-if="props.row.accountId === ''" v-permission="'SYS_ENT_PERSON_ACCOUNT'">开通账号
							</fb-button>
							<fb-button @on-click="handleAccount(props.row)" editor
									   size="s" v-if="props.row.accountId !== ''" v-permission="'SYS_ENT_PERSON_ACCOUNT'">账号
							</fb-button>
							<fb-button @on-click="resetpwd(props.row)" size="s" type="primary" v-if="props.row.accountId !== ''">
								密码重置
							</fb-button>
							...
							<fb-button @on-click="handleAuth(props.row)" editor
									   size="s" v-permission="'SYS_ENT_PERSON_AUTHADD'">授权
							</fb-button>
						</fb-space>
					</template>
